...
int main(int argc, char *const argv[])
{
  ...
  uint8_t defaultKeys[][6] = {
    ...
    {0x42, 0x40, 0x01, 0x77, 0x12, 0x66},
    {0x70, 0x50, 0x02, 0x02, 0x21, 0x60},
    {0x38, 0x33, 0x36, 0x39, 0x35, 0x34},
    {0x84, 0x98, 0xad, 0x6b, 0x9d, 0xae},
    {0xb9, 0xed, 0x17, 0xf9, 0xe4, 0x3c},
    {0x20, 0x80, 0x20, 0x13, 0x12, 0x27},
    {0xa8, 0x41, 0xb3, 0x4f, 0xc9, 0x50},
    {0x19, 0x86, 0xca, 0xfe, 0xfa, 0xce},
    {0x05, 0x32, 0x20, 0x80, 0x07, 0x08},
    {0xf8, 0x9c, 0x86, 0xb2, 0xa9, 0x61},
    {0x97, 0x12, 0x0a, 0x67, 0x27, 0x12},
    {0x18, 0xfc, 0xa9, 0xeb, 0x83, 0x75},
    {0xef, 0x26, 0xa3, 0x3b, 0x66, 0x52},
    {0xc3, 0x99, 0x15, 0xc4, 0xd1, 0xb2},
    {0x1c, 0xe2, 0xbc, 0x68, 0x7a, 0x22},
    {0xbc, 0x67, 0x19, 0xd2, 0x08, 0x22},
    {0x94, 0x03, 0x89, 0xcb, 0x2b, 0xfc},
    {0xc1, 0x42, 0x6c, 0xa0, 0xa6, 0x62},
    {0xc9, 0x71, 0x3c, 0x14, 0x4a, 0x92},
    {0x24, 0x85, 0x24, 0xa7, 0x81, 0x52},
    {0x62, 0x4a, 0x58, 0x18, 0x79, 0x52},
    {0x8d, 0xec, 0xc1, 0x18, 0x45, 0xea},
    {0x13, 0x31, 0x53, 0x12, 0xbe, 0x52},
    {0x89, 0x86, 0x03, 0x19, 0x0f, 0x32},
    {0xa5, 0xff, 0x3b, 0x6b, 0xd3, 0x32},
    {0xc4, 0x25, 0xcf, 0x10, 0x57, 0x0d},
    {0x8e, 0x20, 0xd5, 0x54, 0x3d, 0xa2},
    {0x84, 0x57, 0x6d, 0xaa, 0xe7, 0x71},
    {0xad, 0x2c, 0xbd, 0xaa, 0x3b, 0xfc},
    {0x88, 0x39, 0x96, 0x80, 0x05, 0x71},
    {0x77, 0x86, 0xfd, 0x8d, 0x87, 0x00}
  };
